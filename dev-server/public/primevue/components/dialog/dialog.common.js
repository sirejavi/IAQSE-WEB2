...
/* harmony default export */ var Dialogvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    focus: function focus() {
      var focusable = DomHandler_DomHandler.getFocusableElements(this.$refs.dialog);
