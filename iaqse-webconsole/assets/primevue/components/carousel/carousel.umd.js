...
// module
exports.push([module.i, ".p-carousel,.p-carousel-content{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.p-carousel-content{overflow:auto}.p-carousel-next,.p-carousel-prev{-ms-flex-item-align:center;align-self:center;-webkit-box-flex:0;-ms-flex-positive:0;flex-grow:0;-ms-flex-negative:0;flex-shrink:0;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.p-carousel-container{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row}.p-carousel-items-content{overflow:hidden}.p-carousel-indicators,.p-carousel-items-container{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row}.p-carousel-indicators{-ms-flex-wrap:wrap;flex-wrap:wrap}.p-carousel-indicator>button,.p-carousel-indicators{-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.p-carousel-indicator>button{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.p-carousel-vertical .p-carousel-container,.p-carousel-vertical .p-carousel-items-container{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.p-carousel-vertical .p-carousel-items-container{height:100%}.p-items-hidden .p-carousel-item{visibility:hidden}.p-items-hidden .p-carousel-item.p-carousel-item-active{visibility:visible}", ""]);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:['p-carousel p-component', {'p-carousel-vertical': _vm.isVertical(), 'p-carousel-horizontal': !_vm.isVertical()}],attrs:{"id":_vm.id}},[(_vm.$scopedSlots.header)?_c('div',{staticClass:"p-carousel-header"},[_vm._t("header")],2):_vm._e(),_c('div',{class:_vm.contentClasses},[_c('div',{class:_vm.containerClasses},[_c('button',{class:['p-carousel-prev p-link', {'p-disabled': _vm.backwardIsDisabled}],attrs:{"disabled":_vm.backwardIsDisabled,"type":"button"},on:{"click":_vm.navBackward}},[_c('span',{class:['p-carousel-prev-icon pi', {'pi-chevron-left': !_vm.isVertical(),'pi-chevron-up': _vm.isVertical()}]})]),_c('div',{staticClass:"p-carousel-items-content",style:([{'height': _vm.isVertical() ? _vm.verticalViewPortHeight : 'auto'}])},[_c('div',{ref:"itemsContainer",staticClass:"p-carousel-items-container",on:{"transitionend":_vm.onTransitionEnd,"touchend":_vm.onTouchEnd,"touchstart":_vm.onTouchStart,"touchmove":_vm.onTouchMove}},[(_vm.isCircular())?_vm._l((_vm.value.slice(-1 * _vm.d_numVisible)),function(item,index){return _c('div',{key:index + '_scloned',class:['p-carousel-item p-carousel-item-cloned',
						...
						'p-carousel-item-end': _vm.lastIndex() === index}]},[_vm._t("item",null,{"data":item,"index":index})],2)}),(_vm.isCircular())?_vm._l((_vm.value.slice(0, _vm.d_numVisible)),function(item,index){return _c('div',{key:index + '_fcloned',class:['p-carousel-item p-carousel-item-cloned',
							...
							'p-carousel-item-start': 0 === index,
							'p-carousel-item-end': _vm.value.slice(0, _vm.d_numVisible).length - 1 === index}]},[_vm._t("item",null,{"data":item,"index":index})],2)}):_vm._e()],2)]),_c('button',{class:['p-carousel-next p-link', {'p-disabled': _vm.forwardIsDisabled}],attrs:{"disabled":_vm.forwardIsDisabled,"type":"button"},on:{"click":_vm.navForward}},[_c('span',{class:['p-carousel-prev-icon pi', {'pi-chevron-right': !_vm.isVertical(),'pi-chevron-down': _vm.isVertical()}]})])]),_c('ul',{class:_vm.indicatorsContentClasses},_vm._l((_vm.totalIndicators),function(indicator,i){return _c('li',{key:'p-carousel-indicator-' + i,class:['p-carousel-indicator', {'p-highlight': _vm.d_page === i}]},[_c('button',{staticClass:"p-link",attrs:{"type":"button"},on:{"click":function($event){return _vm.onIndicatorClick($event, i)}}})])}),0)]),(_vm.$scopedSlots.footer)?_c('div',{staticClass:"p-carousel-footer"},[_vm._t("footer")],2):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/carousel/Carousel.vue?vue&type=template&id=1a1a4c72&
