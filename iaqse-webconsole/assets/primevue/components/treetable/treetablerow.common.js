...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('tr',{class:_vm.containerClass,style:(_vm.node.style),attrs:{"tabindex":"0"},on:{"click":_vm.onClick,"keydown":_vm.onKeyDown,"touchend":_vm.onTouchEnd}},_vm._l((_vm.columns),function(col,i){return _c('td',{key:col.columnKey||col.field||i,class:col.bodyClass,style:(col.bodyStyle)},[(col.expander)?_c('span',{staticClass:"p-treetable-toggler",style:(_vm.togglerStyle),on:{"click":_vm.toggle}},[_c('i',{class:_vm.togglerIcon})]):_vm._e(),(_vm.checkboxSelectionMode && col.expander)?_c('div',{staticClass:"p-checkbox p-treetable-checkbox p-component",attrs:{"role":"checkbox","aria-checked":_vm.checked},on:{"click":_vm.toggleCheckbox}},[_c('div',{staticClass:"p-hidden-accessible"},[_c('input',{attrs:{"type":"checkbox"},on:{"focus":_vm.onCheckboxFocus,"blur":_vm.onCheckboxBlur}})]),_c('div',{ref:"checkboxEl",refInFor:true,class:_vm.checkboxClass},[_c('span',{class:_vm.checkboxIcon})])]):_vm._e(),(col.$scopedSlots.body)?_c('TTColumnSlot',{attrs:{"node":_vm.node,"column":col,"type":"body"}}):_vm._e(),[_vm._v(_vm._s(_vm.resolveFieldData(_vm.node.data, col.field)))]],2)}),0)}
var staticRenderFns = []
